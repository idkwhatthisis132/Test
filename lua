...
-- Create Draggable TextButton (top-right corner)
local button = Instance.new("TextButton")
button.Size = UDim2.new(0, 250, 0, 50)
button.Position = UDim2.new(1, -260, 0, 10) -- Top right, with padding
button.AnchorPoint = Vector2.new(0, 0) -- Anchor from top-left corner of button
button.Text = "Instant loop dash / Kiba tech V3"
button.Active = true
